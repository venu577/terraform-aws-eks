module "ingress_alb" {
    ...
    source = "git::https://github.com/venu577/terraform-aws-securitygroup.git?ref=main"
    project = var.project
    environment = var.environment

    sg_name = "ingress-alb"
    description = "for ingress alb"
    vpc_id = local.vpc_id
}
...
module "eks_control_plane" {
    ...
    description = "for eks_control_plane"
    vpc_id = local.vpc_id
}
